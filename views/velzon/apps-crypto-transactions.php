...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Transactions')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Crypto', 'title'=>'Transactions')); ?>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/eur.svg" alt="" class="avatar-xxs me-2">
                                                    EUR
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/gbp.svg" alt="" class="avatar-xxs me-2">
                                                    GBP
                                                </div>
                                            </td>
                                            <td class="form_name">Wallet</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/jpy.svg" alt="" class="avatar-xxs me-2">
                                                    JPY
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/xpm.svg" alt="" class="avatar-xxs me-2">
                                                    XPM
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center">
                                                    <img src="/images/svg/crypto-icons/ppt.svg" alt="" class="avatar-xxs me-2">
                                                    PPT
                                                </div>
                                            </td>
    ...
    <script src="/js/pages/crypto-transactions.init.js"></script>
