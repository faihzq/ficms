...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Profile Settings')); ?>
...
<body>
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                            <img src="/images/users/avatar-1.jpg" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
    ...
    <script src="/js/pages/profile-setting.init.js"></script>
