        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Pages', 'title'=>'Timeline')); ?>
                            ...
                            <div>
                                ...
                                <div class="timeline">
                                        ...
                                        <div class="content">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="/images/users/avatar-5.jpg" alt="" class="avatar-sm rounded">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="fs-14">@Erica245 <small class="text-muted fs-13 fw-normal">- 10 min Ago</small></h5>
                                    ...
                                    <div class="timeline-item right">
                                        ...
                                        <div class="content">
                                            <h5 class="fs-14">Donald Palmer <small class="text-muted fs-13 fw-normal">- Has changed 2 attributes</small></h5>
                                    ...
                                    <div class="timeline-item right">
                                        ...
                                        <div class="content">
                                            <h5 class="fs-14">New ticket received <span class="badge bg-soft-success text-success fs-10 align-middle ms-1">Completed</span></h5>
                                            ...
                                            <div class="col-12">
                                                <div class="timeline-box">
                                                    <div class="timeline-text">
                                                        ...
                                                        <div class="row border border-dashed rounded gx-2 p-2">
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/images/small/img-7.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/images/small/img-3.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/images/small/img-10.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/images/small/img-9.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                        </div>
                                                    </div>
