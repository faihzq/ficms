        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Ecommerce', 'title'=>'Order Details')); ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-14"><a href="apps-ecommerce-product-details" class="text-body">Noise NoiseFit Endure Smart Watch</a></h5>
