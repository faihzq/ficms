...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Invoice Details')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Invoices', 'title'=>'Invoice Details')); ?>
    ...
    <script src="/js/pages/invoicedetails.js"></script>
