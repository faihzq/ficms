...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Checkout')); ?>
...
<body>
        ...
        <div class="main-content overflow-hidden">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Ecommerce', 'title'=>'Checkout')); ?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="pills-finish" role="tabpanel" aria-labelledby="pills-finish-tab">
                                                <div class="text-center py-5">
                                                    ...
                                                    <h3>Order ID: <a href="apps-ecommerce-order-details" class="text-decoration-underline">VZ2451</a></h3>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                        </div>
    ...
    <!-- init js -->
    <script src="/js/pages/ecommerce-product-checkout.init.js"></script>
