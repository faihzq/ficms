...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Tasks List')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Tasks', 'title'=>'Tasks List')); ?>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="mary-gant">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/images/users/avatar-4.jpg" alt="" class="avatar-xxs rounded-circle">
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="diego-norris">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="/images/users/avatar-9.jpg" alt="" class="avatar-xxs rounded-circle">
                                                                    </span>
