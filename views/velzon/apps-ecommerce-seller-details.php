...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Seller Details')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Ecommerce', 'title'=>'Seller Details')); ?>
                                    ...
                                    <div>
                                        <div class="flex-shrink-0 avatar-md mx-auto">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="/images/companies/img-2.png" alt="" height="50" />
                                            </div>
                                        </div>
    ...
    <script src="/js/pages/seller-details.init.js"></script>
