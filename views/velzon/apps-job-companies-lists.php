<?php echo $this->render('partials/main'); ?>
    ...
    <head>
        ...
        <?php echo $this->render('partials/title-meta', array('title' => 'Companies List')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php echo $this->render('partials/page-title', array('pagetitle'=>'Companies', 'title'=>'Companies List')); ?>
