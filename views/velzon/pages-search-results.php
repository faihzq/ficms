...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Search Results')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Pages', 'title'=>'Search Results')); ?>
                                ...
                                <div class="card-body p-4">
                                    <div class="tab-content text-muted">
                                        <div class="tab-pane active" id="all" role="tabpanel">
                                            <div class="pb-3">
                                                <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Velzon - Responsive Bootstrap 5 Admin Dashboard</a></h5>
                                                    ...
                                                    <div class="col-xl-4 col-lg-10">
                                                        <div class="row g-2">
                                                            <div class="col-md-3 col-sm-6">
                                                                <div>
                                                                    <a href="/images/small/img-1.jpg" class="image-popup d-block">
                                                                        <img src="/images/small/img-1.jpg" alt="" class="img-fluid d-block rounded" />
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-md-3 col-sm-6">
                                                                <div>
                                                                    <a href="/images/small/img-3.jpg" class="image-popup d-block">
                                                                        <img src="/images/small/img-3.jpg" alt="" class="img-fluid d-block rounded" />
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-md-3 col-sm-6">
                                                                <div>
                                                                    <a href="/images/small/img-4.jpg" class="image-popup d-block">
                                                                        <img src="/images/small/img-4.jpg" alt="" class="img-fluid d-block rounded" />
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-md-3 col-sm-6">
                                                                <div class="search-more-results rounded">
                                                                    <a href="javascript:void(0);" onclick="myFunction()" class="d-block">
                                                                        <img src="/images/small/img-5.jpg" alt="" class="img-fluid d-block rounded" />
                                            ...
                                            <div class="py-3">
                                                <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Skote - Admin & Dashboard Template by Themesbrand</a></h5>
                                            ...
                                            <div class="py-3">
                                                <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Minia - React Js Admin & Dashboard Template</a></h5>
                                            ...
                                            <div class="py-3">
                                                <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Doson - Angular Admin & Dashboard Template by Themesbrand</a></h5>
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-12.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-11.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-10.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-9.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-8.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-7.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-6.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-5.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                                    <div class="flex-shrink-0">
                                                                        <img src="/images/small/img-3.jpg" alt="" width="65" class="rounded" />
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="gallery-light">
                                                <div class="row">
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-1.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-1.jpg" alt="" />
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-2.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-2.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-3.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-3.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-4.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-4.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-5.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-5.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-6.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-6.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-7.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-7.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-8.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-8.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                                        <h5 class="overlay-caption">Glasses and laptop from above</h5>
                                                                    </div>
                                                                </a>
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-9.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-9.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-10.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-10.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-11.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-11.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card">
                                                            <div class="gallery-container">
                                                                <a class="image-popup" href="/images/small/img-12.jpg" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="/images/small/img-12.jpg" alt="" />
                                                                    <div class="gallery-overlay">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/images/small/img-1.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    ...
                                                                    <h5 class="fs-15"><a href="javascript:void(0);">A mix of friends and strangers heading off to find an adventure</a></h5>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/images/small/img-2.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge badge-soft-warning fs-11">Development</span></li>
                                                                    </ul>
                                                                    <h5 class="fs-15"><a href="javascript:void(0);">How to get creative in your work ?</a></h5>
                                                                    <ul class="list-inline mb-0">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/images/small/img-3.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge badge-soft-info fs-11">Fashion</span></li>
                                                                    </ul>
                                                                    <h5 class="fs-15"><a href="javascript:void(0);">How to become a best sale marketer in a year!</a></h5>
                                                                    <ul class="list-inline mb-0">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/images/small/img-4.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge badge-soft-primary fs-11">Product</span></li>
                                                                    </ul>
                                                                    <h5 class="fs-15"><a href="javascript:void(0);">Manage white space in responsive layouts ?</a></h5>
                                                                    <ul class="list-inline mb-0">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/images/small/img-5.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge badge-soft-success fs-11">Business</span></li>
                                                                    </ul>
                                                                    <h5 class="fs-15"><a href="javascript:void(0);">Stack designer Olivia Murphy offers freelancing advice</a></h5>
                                                                    <ul class="list-inline mb-0">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/images/small/img-6.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge badge-soft-danger fs-11">Design</span></li>
                                                                    </ul>
                                                                    <h5 class="fs-15"><a href="javascript:void(0);">A day in the of a professional fashion designer</a></h5>
                                                                    <ul class="list-inline mb-0">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/images/small/img-7.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge badge-soft-danger fs-11">Design</span></li>
                                                                    </ul>
                                                                    <h5 class="fs-15"><a href="javascript:void(0);">Design your apps in your own way</a></h5>
                                                                    <ul class="list-inline mb-0">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/images/small/img-8.jpg" alt="" width="115" class="rounded-1" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge badge-soft-warning fs-11">Development</span></li>
                                                                    </ul>
                                                                    <h5 class="fs-15"><a href="javascript:void(0);">How apps is changing the IT world</a></h5>
                                                                    <ul class="list-inline mb-0">
                                                                        <li class="list-inline-item"><i class="ri-user-3-fill text-success align-middle me-1"></i> Elwood Arter</li>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 video-list">
                                                    <div class="list-element">
                                                        <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Admin dashboard templates - Material Design for Velzon</a></h5>
                                                    ...
                                                    <div class="list-element mt-4">
                                                        <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Create Responsive Admin Dashboard using Html CSS</a></h5>
                                                        <p class="text-success">https://themesbrand.com/velzon/index.html</p>
                                                        <div class="d-flex flex-column flex-sm-row">
                                                            <div class="flex-shrink-0">
                                                    ...
                                                    <div class="list-element mt-4">
                                                        <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Velzon - The Most Popular Bootstrap 5 HTML, Angular & React Js Admin</a></h5>
                                                        <p class="text-success">https://themesbrand.com/velzon/index.html</p>
                                                        <div class="d-flex flex-column flex-sm-row">
                                                            <div class="flex-shrink-0">
                                                    ...
                                                    <div class="list-element mt-4">
                                                        <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Velzon Admin Dashboard (website analytics) with Bootstrap 5</a></h5>
                                                        <p class="text-success">https://themesbrand.com/velzon/index.html</p>
                                                        <div class="d-flex flex-column flex-sm-row">
                                                            <div class="flex-shrink-0">
                                                                <iframe src="https://www.youtube.com/embed/Z-fV2lGKnnU" title="YouTube video" allowfullscreen class="rounded"></iframe>
                                                    ...
                                                    <div class="list-element mt-4">
                                                        <h5 class="fs-14 mb-1"><a href="javascript:void(0);">Dashboard Admin Basics - YouTube</a></h5>
                                                        <p class="text-success">https://themesbrand.com/velzon/index.html</p>
                                                        <div class="d-flex flex-column flex-sm-row">
                                                            <div class="flex-shrink-0">
    ...
    <script src="/js/pages/search-result.init.js"></script>
