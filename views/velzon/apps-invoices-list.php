...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Invoice List')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Invoices', 'title'=>'Invoice List')); ?>
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            ...
                                            <a href="apps-invoices-create" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> Create Invoice</a>
    ...
    <!-- invoicelist init js -->
    <script src="/js/pages/invoiceslist.init.js"></script>
