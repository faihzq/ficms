...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Listjs')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Tables', 'title'=>'Listjs')); ?>
                                            ...
                                            <ul class="list list-group list-group-flush mb-0">
                                                <li class="list-group-item" data-id="1">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="/images/users/avatar-1.jpg">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="2">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="/images/users/avatar-2.jpg">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="/images/users/avatar-3.jpg">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="4">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="/images/users/avatar-4.jpg">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
    ...
    <!-- listjs init -->
    <script src="/js/pages/listjs.init.js"></script>
