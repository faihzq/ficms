...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Contacts')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'CRM', 'title'=>'Contacts')); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="name">
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0"><img src="/images/users/avatar-10.jpg" alt="" class="avatar-xs rounded-circle"></div>
                                                                    ...
                                                                    <div class="position-relative d-inline-block">
                                                                        ...
                                                                        <div class="avatar-lg p-1">
                                                                            <div class="avatar-title bg-light rounded-circle">
                                                                                <img src="/images/users/user-dummy-img.jpg" id="customer-img" class="avatar-md rounded-circle object-cover" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="col-xxl-3">
                            <div class="card" id="contact-view-detail">
                                <div class="card-body text-center">
                                    <div class="position-relative d-inline-block">
                                        <img src="/images/users/avatar-10.jpg" alt="" class="avatar-lg rounded-circle img-thumbnail">
    ...
    <script src="/js/pages/crm-contact.init.js"></script>
