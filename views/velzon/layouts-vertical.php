...
<head>
    ...
    <?php echo $this->render('partials/title-meta', array('title' => 'Vertical Layout')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('partials/page-title', array('pagetitle'=>'Layouts', 'title'=>'Vertical')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body p-0">
                                    <div>
                                        <div id="audiences-sessions-country-charts" data-colors='["--vz-success", "--vz-info"]' class="apex-charts"></div>
                                    </div>
                                </div><!-- end cardbody -->
                            </div><!-- end card -->
                        </div><!-- end col -->
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    <div id="user_device_pie_charts" data-colors='["--vz-primary", "--vz-warning", "--vz-info"]' class="apex-charts" dir=""></div>
