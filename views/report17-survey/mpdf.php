...
<div class="text-center">
    ...
    <h4 class="text-right" style="margin: 0px; margin-right: 20px;">JADUAL 17B</h4>
...
<div class="indent-main">
    <table border="0" width="100%">
        <tr>
            <td>
                Rujukan kepada No. Laporan Latent Defect (LD) / Tarikh
            </td>
            <td width="10px">
                :
            </td>
...
<div class="indent-main">
    ...
    <div style="width:40%; float:right;margin-right: 40px;">
        <?php if ($model->commander_sign){ ?>
            <img src="<?= \Yii::getAlias('@web');?>/uploads/report17Survey/sign/<?= $model->commander_sign_pic ?>" alt="">
            <table autosize="1" width="100%" border="0">
                <tbody>
                    <tr>
...
<div style="margin-top: 20px;position: fixed; bottom: 0px;text-align: center;width: 100%;">
    ...
    <p style="margin:0 0 10 0px; font-size:12px">MUKA SURAT J17B-1 DARI J17B-1</p>
    <h4 style="margin: 0px">SULIT</h4>
</div>
