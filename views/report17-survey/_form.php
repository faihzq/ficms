...
<div class="report17-survey-form">
        ...
        <div class="col-lg-9">
            ...
            <div class="card">
                <div class="card-body">
                   <div class="row">
                        <div class="col-md-4">
                            <?= $form->field($model, 'report_damage_id')->dropDownList($listReport17Defect, ['data-choices' => '', 'disabled'=>true]) ?>
                        </div>
                        <div class="col-md-4">
...
<script>
    $(function(){
        ...
        $(document).ready(function() {
          ...
          $('#report17survey-report_damage_id').change(function() {
