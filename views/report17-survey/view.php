...
<div class="report17-survey-view">

    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Laporan Tinjauan Pakar</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><?php echo $model->getAttributeLabel('damage_type_survey_id'); ?></th>
                                    <td><?php echo nl2br($model->damageSurvey->name) ?></td>
                                </tr>
                                <tr>
                                    <th scope="row"><?php echo $model->getAttributeLabel('damage_category_id'); ?></th>
                                    <td><?php echo nl2br($model->damageCategory->name) ?></td>
                                </tr>
                                <tr>
                                    <th scope="row"><?php echo $model->getAttributeLabel('damage_description'); ?></th>
                                    <td><?php echo nl2br($model->damage_description) ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo nl2br($model->probable_cause) ?></td>
                                    
                                </tr>
                                <tr>
                                    <th scope="row"><?php echo $model->getAttributeLabel('boat_status_id'); ?></th>
                                    <td><div class="badge rounded-pill <?php echo $model->statusBoat->statusLabel?> fs-12"><?php echo $model->statusBoat->name?></div></td>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo nl2br($model->suggested_correction) ?></td>
                                </tr>
                                <tr>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-sm-12">
                                <?= Html::a('<i class="mdi mdi-printer-outline label-icon align-middle rounded-pill"></i>Cetak', ['pdf', 'id' => $model->id], ['class' => 'btn btn-label rounded-pill btn-secondary btn-animation bg-gradient waves-effect waves-light d-grid gap-2 mb-2', 'target' => '_blank']) ?>
                            </div>
