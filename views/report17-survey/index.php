...
<div class="report17-survey-index">
                            ...
                            <table class="table align-middle mb-0">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="warranty" scope="col">Tanggungan LD
                                        </th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="report_damage_id"><a href="<?= Url::to(['report17-defect/view','id'=>$report->report_damage_id]) ?>" target="_blank"><?php echo $report->reportDamage->report_no ?></a>
                                        </td>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Lihat">
                                                    <a href="<?php echo Url::to(['report17-survey/view','id'=>$report->id]) ?>" class="text-muted d-inline-block">
                                                        <i class="ri-eye-fill fs-16"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Cetak">
                                                    <a href="<?php echo Url::to(['report17-survey/pdf','id'=>$report->id]) ?>" class="text-muted d-inline-block" target="_blank">
                                                ...
                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                    <a href="<?php echo Url::to(['report17-survey/update','id'=>$report->id]) ?>" class="text-muted d-inline-block">
