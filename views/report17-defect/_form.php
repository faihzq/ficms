...
?>
<div class="report17-defect-form">
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <p class="text-muted">Pemberitahuan pendaftaran Latent Defect (LD) sebagaimana ditentukan dalam Klausa 23.</p>
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6" id="uploadFileId">
                                    ...
                                    <?php if ($model->support_doc_1): ?>
                                        <div class="mb-3">
                                            <a href="<?php echo $baseUrl.'/uploads/report17Defect/';echo $model->support_doc_1; ?>" title="Download" class="btn btn-outline-primary" target="_blank"><i class="mdi mdi-cloud-download-outline"></i> <?php echo $model->support_doc_1 ?></a>
                                            <a href="<?= Url::to(['report17-defect/download','filename'=>$model->support_doc_1]) ?>" title="Download" class="btn btn-outline-success btn-icon waves-effect waves-light" target="_blank"><i class="mdi mdi-cloud-download-outline"></i> </a>
                                    ...
                                    <?php if ($model->support_doc_2): ?>
                                        <div class="mb-3">
                                            <a href="<?php echo $baseUrl.'/uploads/report17Defect/';echo $model->support_doc_2; ?>" title="Download" class="btn btn-outline-primary" target="_blank"><i class="mdi mdi-cloud-download-outline"></i> <?php echo $model->support_doc_2 ?></a>
                                            <a href="<?= Url::to(['report17-defect/download','filename'=>$model->support_doc_2]) ?>" title="Download" class="btn btn-outline-success btn-icon waves-effect waves-light" target="_blank"><i class="mdi mdi-cloud-download-outline"></i> </a>
...
<script>
    function removeFile(id,filename){
        ...
        swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
                url: '<?= Url::to(['report17-defect/remove-file']) ?>',
                method: 'GET',
    ...
    var cleaveBlocks = new Cleave('#report17defect-contact_officer_tel', {
        phone: true,
    });

     $(document).ready(function() {

        var equipmentDropdown = $('#report17defect-equipment_id');
        var equipmentSerialInput = $('#report17defect-equipment_serial');
