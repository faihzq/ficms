                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Lihat">
                                                    <a href="<?= Url::to(['report17-defect/view','id'=>$report->id]) ?>" class="text-muted d-inline-block">
                                                        <i class="ri-eye-fill fs-16"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Cetak">
                                                    <a href="<?= Url::to(['report17-defect/pdf','id'=>$report->id]) ?>" class="text-muted d-inline-block" target="_blank">
                                                ...
                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                    <a href="<?= Url::to(['report17-defect/update','id'=>$report->id]) ?>" class="text-muted d-inline-block">
